/*
Filename:           prr_a_dmtpcrd
System:             Persistent Reputation & Reaction (prr_dmtool conversation action)
Author:             Michael A. Sinclair (Squatting Monk)
Date Created:       Feb. 4th, 2009
Summary:
PRR DM Tool action script that sets the PC's reputation with the NPC to the min
...
void main()
{
    ...
    prr_SetExternalReputation(oNPC, oPC, PRR_REPUTATION_MIN);
}

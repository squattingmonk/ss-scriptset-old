...
reputation with the NPC can be set to the max amount set in prr_c_main.
...
int StartingConditional()
{
    ...
    if (nReputation == PRR_REPUTATION_MAX)
        return FALSE;

    SetCustomToken(PRR_TOKEN_DM_TOOL_REPUTATION_EXTREME, IntToString(PRR_REPUTATION_MAX));
    return TRUE;
}

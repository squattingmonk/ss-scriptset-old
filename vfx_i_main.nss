/*
Filename:           vfx_i_main
System:             Visual Effects System  (include script)
Author:             Sherincall (Sherincall@gmail.com)
Date Created:       April 06, 2009
Summary:
Visual Effects System master include library. This file contains functions used
to create VFXs.

The scripts contained herein are based on those included in the Sunjammer's
TileMagic, and gaoneng's Pentagrams and Summoning Circles, customized for
compatibility with Shadows & Silver's needs.
